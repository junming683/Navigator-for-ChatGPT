...
The Extension operates entirely locally on your device. It interacts with the ChatGPT website (`https://chatgpt.com`) solely to generate a table of contents for your current conversation.

### Local Storage
The Extension uses your browser's local storage capabilities (`chrome.storage.local`) for the following specific purpose:
*   **Saving User Preferences**: To store the custom names you assign to items in the table of contents.

This data is stored locally on your device and is **never** transmitted to us or any third-party servers.

## 2. Third-Party Services

The Extension does not integrate with any third-party analytics tools (such as Google Analytics) or advertising networks.
